                ...
                <div class="message-box">
                    ...
                    <div class="buttons-con">
                        <div class="action-link-wrap">
                            <a onclick="history.back(-1)" href="javascript:void(null)"
                               class="btn btn-custom btn-primary waves-effect waves-light m-t-20"><i
                                        class="fa fa-reply"></i> Voltar</a>
                            <a href="{{url('')}}" class="btn btn-custom btn-primary waves-effect waves-light m-t-20"><i
                                        class="fa fa-home"></i> Ir Para Tela Principal</a>
                        </div>
                    </div>
                </div>
            </div>
